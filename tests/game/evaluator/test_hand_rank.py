...
@pytest.mark.parametrize(
    ...
    [
        # 不同牌型比较：同花顺 > 顺子
        (HandRank.STRAIGHT_FLUSH, [Rank.A, Rank.K, Rank.Q, Rank.J, Rank.TEN], HandRank.STRAIGHT, [Rank.A, Rank.K, Rank.Q, Rank.J, Rank.TEN], "greater"),
        
        # 相同牌型，不同高牌：两个顺子，一个以Ace高，另一个以King高
        (HandRank.STRAIGHT, [Rank.A, Rank.K, Rank.Q, Rank.J, Rank.TEN], HandRank.STRAIGHT, [Rank.K, Rank.Q, Rank.J, Rank.TEN, Rank.NINE], "greater"),
        
        # 完全相同的手牌：同样的顺子，Ace高
        (HandRank.STRAIGHT, [Rank.A, Rank.K, Rank.Q, Rank.J, Rank.TEN], HandRank.STRAIGHT, [Rank.A, Rank.K, Rank.Q, Rank.J, Rank.TEN], "equal"),
        
        # 相同牌型，低牌比高牌：两个顺子，King高的低于Ace高的
        (HandRank.STRAIGHT, [Rank.K, Rank.Q, Rank.J, Rank.TEN, Rank.NINE], HandRank.STRAIGHT, [Rank.A, Rank.K, Rank.Q, Rank.J, Rank.TEN], "less"),
    ]
)
